...
email_input = dbc.Form([
    ...
    ], width=6, className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12", style={'width': '80%'}),
    dbc.Col([
        html.Div([
...
], className="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-xl-10", style={'width': '80%'})


em_toast = dbc.Container([
    dbc.Toast(
        dbc.Container([
