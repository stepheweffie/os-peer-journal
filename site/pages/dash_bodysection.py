...
eye_body_section = dbc.Container([
    dbc.Container([
       ...
       ], className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-8", style={'max-width': '100%'}),
    dbc.Container([
            dbc.Col([
